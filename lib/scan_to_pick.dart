...
class ScanToPickPage extends StatefulWidget {
  @override
  _ScanToPickPageState createState() => _ScanToPickPageState();
}

class _ScanToPickPageState extends State<ScanToPickPage> {
